(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dap-mode lsp-ui use-package posframe company-lsp sbt-mode nix-update nix-mode racer flycheck-pycheckers flycheck-kotlin kotlin-mode scala-mode flycheck-rust cargo js-comint nodejs-repl csv-mode typescript carbon-now-sh tide graphql-mode typescript-mode markdown-preview-mode editorconfig groovy-mode helm-ag go-eldoc go-playground company-go go-mode exec-path-from-shell company-tern flycheck-apertium flycheck-elm elm-mode jsx-mode js2-mode jade-mode cider cmake-mode nsis-mode emoji-cheat-sheet-plus google-translate babel hackernews helm-smex helm-mu multiple-cursors helm-flx helm-fuzzier helm-make helm-notmuch helm-package helm-unicode swiper-helm helm-projectile helm nm notmuch notmuch-labeler fill-column-indicator zoom-window zeal-at-point yaml-mode xterm-color web-mode w3 vline travis string-utils smex skewer-mode skeletor shell-toggle scss-mode sass-mode rust-mode request-deferred realgud rainbow-delimiters projectile nginx-mode neotree multi-term monokai-theme modern-cpp-font-lock markdown-mode+ magit-filenotify jack-connect jabber-otr ido-ubiquitous haskell-mode git-messenger gist geiser flymake-yaml flymake-sass expand-region emms dumb-jump dirtree dirtrack-buffer-name-track-mode diminish dedicated cyberpunk-theme cmake-ide clojurescript-mode clojure-cheatsheet cljsbuild-mode circe bitlbee auctex apt-utils adaptive-wrap)))
