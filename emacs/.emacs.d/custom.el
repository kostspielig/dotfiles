(custom-set-variables
 ...
 '(LaTeX-command-style '(("" "%(latex) %S%(PDFout)")))
 ...
 '(css-indent-offset 2)
 '(custom-enabled-themes '(jpb-wombatish))
 '(custom-safe-themes
 ...
 '(menu-bar-mode nil)
 '(mu4e-completing-read-function 'completing-read t)
 '(mu4e-maildir "~/mail")
