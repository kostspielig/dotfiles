...
(defun color-theme-jpb-black ()
  ...
  (color-theme-install
   '(color-theme-jpb-black
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "#9999ee" :weight bold))))
     (font-lock-keyword-face ((t (:bold t :foreground "orange red" :weight bold))))
     ...
     (font-lock-variable-name-face ((t (:bold t :foreground "sky blue" :weight bold))))
